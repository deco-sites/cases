...
export default function Chat({ messages }: Props) {
  return (
    <div class="relative flex justify-center">
      ...
      />
      <div class="sm:max-w-[44vh] max-h-[100vh] sm:max-h-[92vh] whatsapp relative sm:absolute sm:top-[4vh] overflow-auto scrollbar-none sm:rounded-[42px]">
        <header class="flex justify-start items-center w-full bg-[#075E54] h-[80px] px-4 fixed sm:top-[4vh] sm:max-w-[44vh] sm:rounded-t-[42px]">
