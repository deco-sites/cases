    ...
    <div class="relative flex justify-center">
      ...
      <div class="sm:max-w-[44vh] max-h-[100vh] sm:max-h-[92vh] whatsapp relative sm:absolute sm:top-[4vh] overflow-auto scrollbar-none sm:rounded-[5vh]">
        <header class="flex justify-start items-center w-full bg-[#075E54] h-[80px] px-4 fixed sm:top-[4vh] sm:max-w-[44vh] sm:rounded-t-[5vh]">
          <img src="/deco.png" alt="" class="rounded-full w-[40px]" />
          <div class="ml-4">
          ...
          <details class="absolute right-[30px]">
            ...
            <ul class="bg-[#273239] p-4 text-white flex flex-col justify-between gap-6 absolute right-[-30px] top-[50px] w-[250px] ">
              <li>
                <a
                  href="https://www.linkedin.com/in/jonatas-venancio-dev/"
                  target="_blank"
                  class="flex gap-4"
                >
                  Jonatas Venâncio
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/guitavano/"
                  target="_blank"
                  class="flex gap-4"
                >
                  Guilherme Tavano
